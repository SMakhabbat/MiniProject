...
public class MainFrame extends JFrame {
 ...
 public static ArrayList<Students> getListStudent() {

     ArrayList<Students> studentList = Client.listStudent();//PackageData.getStudentList() ;//??
     listStudent.getTable(studentList);
        return studentList;
    }
